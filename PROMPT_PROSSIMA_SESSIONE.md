...
## Stato attuale — Brigade v120

Supabase project: ydqmumpytgrlceuinoqt
Deploy: https://1cos.github.io/back-of-house — branch brigade-main
souschef-scan: v3, souschef-chat: v15

---

## PASSO 1 — COMPLETATO v120
...
- Prompt serale 22:30 Texas riparato (era caricato due volte in index.html)
...
## Database ingredienti — pulito v120

- Da 405 a 337 ingredienti attivi
- Tutti i nomi in inglese
- Emoji 80+ pattern per tutti gli ingredienti
- Tutti i bug di colonne eliminate corretti in ingredients.js
