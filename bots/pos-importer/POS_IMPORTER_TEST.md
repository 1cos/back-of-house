# POS_IMPORTER_TEST — Checklist di Verifica

## Come triggare il bot manualmente

### Via Supabase Dashboard (Edge Functions)
1. Apri Supabase → Edge Functions → bot-pos-importer
2. Clicca "Invoke"
...
```bash
curl -X POST \
  "https://ydqmumpytgrlceuinoqt.supabase.co/functions/v1/bot-pos-importer" \
