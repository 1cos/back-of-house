# POS_IMPORTER_COMMIS — Manuale di Stazione

## Identità
- **Nome:** pos-commis-auditor
- **Versione:** v1
- **Tipo:** modulo dentro bot-pos-importer
- **Brigata:** Sprint 1 — Fondazione

## Responsabilità (una sola)
Controllare l'output del POS Importer e scrivere osservazioni in `commis_observations`.
...
## Scrive solo in
`commis_observations` con `bot_name='pos-importer'` e `commis_name='pos-commis-auditor'`

## Idempotenza
Prima di scrivere, cancella le observation esistenti per:
- `business_date = target_date`
- `bot_name = 'pos-importer'`
- `commis_name = 'pos-commis-auditor'`
